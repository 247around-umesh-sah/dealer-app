...
import com.example.RetailApp.entity.BookingInfo;
...
//        });
        ...
        rowLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  if (isEditBooking((EOBooking) v.getTag())) {
                    Fragment fragment = new FragmentLoader(getMainActivity());
                    Bundle bundl = new Bundle();
                    bundl.putParcelable("eoBooking", eoBooking);
                    bundl.putString(BMAConstants.HEADER_TXT, eoBooking.bookingID);
                    fragment.setArguments(bundl);
